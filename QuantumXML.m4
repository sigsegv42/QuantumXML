# additional m4 rules
# config.nice support lifted from Apache APR (QUANTUMXML_EXPAND_VAR & QUANTUMXML_CONFIG_NICE)
#
...
dnl bar='${foo}/2'
dnl baz='${bar}/3'
dnl QUANTUMXML_EXPAND_VAR(fraz, $baz)
dnl   $fraz is now "1/2/3"
dnl 
AC_DEFUN([QUANTUMXML_EXPAND_VAR],[
ap_last=
ap_cur="$2"
...
dnl QUANTUMXML_CONFIG_NICE(filename)
dnl
dnl Saves a snapshot of the configure command-line for later reuse
dnl
AC_DEFUN([QUANTUMXML_CONFIG_NICE],[
  rm -f $1
  cat >$1<<EOF
#! /bin/sh
#
